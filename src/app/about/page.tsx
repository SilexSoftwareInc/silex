          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
            {values.map((value, i) => (
              <ScrollReveal key={value.number} delay={i * 80}>
                <div className="group border border-[var(--color-border)] p-8 transition-colors duration-100 hover:bg-[var(--color-foreground)] hover:text-[var(--color-background)] h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            {team.map((member, i) => (
              <ScrollReveal key={member.name} delay={i * 100}>
                <div className="border border-[var(--color-border)] p-8 md:p-10">
