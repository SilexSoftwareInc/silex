          ...
          <div className="space-y-0">
            {faqs.map((faq, i) => (
              <ScrollReveal key={faq.question} delay={i * 60}>
                <div className="border-t border-[var(--color-border)] py-8 px-4 md:px-8 last:border-b">
                  <h3 className="font-[family-name:var(--font-display)] text-xl md:text-2xl tracking-tight mb-4">
                    {faq.question}
                  </h3>
                  <p className="text-sm leading-relaxed text-[var(--color-mutedForeground)] max-w-3xl">
                    {faq.answer}
                  </p>
                </div>
              </ScrollReveal>
