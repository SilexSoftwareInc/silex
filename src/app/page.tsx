...
export const metadata: Metadata = createMetadata({
  description:
    "Silex Software Inc builds secure, scalable, and intelligent enterprise software for government and enterprise organizations. Custom applications, web platforms, AI integration, and DevOps.",
  path: "/",
  keywords: [
    "enterprise software",
