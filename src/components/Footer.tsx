          ...
          <div>
            ...
            <div className="mt-6 space-y-1">
              <a
                ...
                className="block text-sm text-[var(--color-mutedForeground)] hover:text-[var(--color-foreground)] transition-colors duration-100 underline-offset-4 hover:underline"
              >
                silexsoftwareinc@gmail.com
              </a>
